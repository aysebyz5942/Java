...
public class SetMain {
    ...
    */
    ...
    set1.add("Javascript");
    set1.add("Php");
    // LinkedHashSet ekleme sırasına gore
    set2.add("Java");
    set2.add("Python");
    set2.add("C++");
    set2.add("Javascript");
    set2.add("Php");
    // TreeSet alfabetik sıralar
    set3.add("Java");
    set3.add("Python");
    set3.add("C++");
    set3.add("Javascript");
    set3.add("Php");
    set3.add("Php"); //aynı eleman oldugu icin 2 defa yazılaaz
    ...
    for (String s: set3){
       ...
       System.out.println(set1.contains("Go"));//icinde olup olmadıgını konreol eder
       System.out.println(set1.contains("Java"));
        
    set1.remove("Java");//siler 
    /*for (String s: set1){
        System.out.println(s);
    ...
    //fark kumesini bulmak icin
   Set<String> fark = new HashSet<String>(set2);//ilk basta set 2 ye esit olmasını istiyoruz
    
        System.out.println(fark.removeAll(set1));//fark kumesinden set1 ve set2 deki farkı alıyor
        System.out.println(fark);//tek olan stringler yazar css ve go
  //kesişim kumesi icin 
    Set<String> kesisim = new HashSet<String>(set2);
    
        System.out.println(kesisim.retainAll(set1));//kesişimlere bakıyor
        System.out.println(kesisim); //ortak olan java dır ve true doner
